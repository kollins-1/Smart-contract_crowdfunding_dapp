...
const ProjectDetails = ({ project }) => {
    ...
    return (
        <div className="py-24 px-20 flex justify-center">
            <div className="flex justify-center items-center flex-col md:w-2/3">
                <div className="flex justify-start items-start sm:space-x-4 flex-wrap">
                    <img src={project?.imageURL} alt={project?.title} className="rounded-xl h-64 w-full object-cover sm:w-1/3"/> 

                    <div className="flex-1 sm:py-0 py-4">
                        <div className="flex flex-col justify-start flex-wrap">
                            <h1 className="text-gray-900 text-xl font-medium mb-2">{project?.title}</h1>
                ...
                <div className="flex justify-center items-center flex-col md:w-2/3">
                    ...
                    <div className="w-full bg-gray-300 mt-4 overflow-hidden ">
                        <div className="bg-red-600 text-xs font-medium text-green-100 text-center p-0.5 leading-none rounded-l-full h-1 overflow-hidden max-w-full" style={{ width: `${(project.raised / project.cost) * 100}%` }}>
                        </div>
                    </div>
